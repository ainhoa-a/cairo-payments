...
fn programmable_pay_test() {
    ...
    // Simulate time passing and verify payments
    advance_time_and_check_payments(ethereum_services_payment, 2);
    advance_time_and_check_payments(game_subscription_payment, 2);
    advance_time_and_check_payments(gym_payment, 2);
}
